  ...
  return (
    <section id="Home Cards">
      <div className="container mx-auto w-full flex flex-col sm:flex-row items-center justify-center py-10 px-5 space-y-5 sm:space-x-3 sm:space-y-0">
        <div className="rounded-md bg-neutral-200 px-6 py-5 flex flex-col space-y-6 w-full duration-500 transition-all drop-shadow-md md:w-1/2 hover:bg-slate-100">
          ...
          <Link
            to="/jobs"
            className="text-indigo-50 self-start duration-300 transition-all rounded-md font-bold px-4 py-3 bg-slate-950 hover:bg-slate-700"
          >
            Browse Jobs
          </Link>
        </div>
        ...
        <div className="rounded-md bg-indigo-100 px-6 py-5 flex flex-col space-y-6 w-full duration-500 transition-all drop-shadow-md md:w-1/2 hover:bg-indigo-50">
          ...
          <Link
            to="/add-job"
            className="text-indigo-50 self-start duration-300 transition-all rounded-md font-bold px-4 py-3 bg-indigo-600 hover:bg-indigo-500"
          >
            Add Job
          </Link>
        </div>
