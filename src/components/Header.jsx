      ...
      <nav className="w-full bg-indigo-700 p-5 border-b border-indigo-600 drop-shadow-md">
        <div className="container flex flex-row mx-auto items-center justify-between">
          ...
          <div className="flex flex-row items-center space-x-3 px-3 py-2">
            <Link to="/" className="text-indigo-100 duration-300 transition-all rounded-md font-bold px-3 py-2 bg-slate-950 hover:bg-slate-900">Home</Link>
            <Link to="/jobs" className="text-indigo-100 duration-300 transition-all rounded-md font-bold px-3 py-2 hover:bg-slate-900">Jobs</Link>
            <Link to="/add-job" className="text-indigo-100 duration-300 transition-all rounded-md font-bold px-3 py-2 hover:bg-slate-900">Add Job</Link>
          </div>
        </div>
      </nav>
    </>
